_: {
  ...
  den.aspects.nono.homeManager = {
    ...
    home = {
      ...
      file = {
        ".config/nono/profiles/pi.json".source = (pkgs.formats.json {}).generate "nono-pi-profile.json" {
          extends = "default";
          meta = {
            name = "pi";
          ...
          # Pi stores OAuth credentials below .pi. The official nono Pi pack
          # does not broker them yet, so this compatibility grant remains until
          # a Pi-specific OAuth capture flow has been proven end to end.
          filesystem = {
            deny = [
          ...
          network = {
            ...
            custom_credentials.supermemory = {
        ...
        ".config/nono/profiles/claude.json".source = (pkgs.formats.json {}).generate "nono-claude-profile.json" {
          extends = "default";
          meta = {
            name = "claude";
